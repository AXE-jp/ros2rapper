...
connect_debug_port u_ila_0/probe0 [get_nets [list {udp_rxbuf_addr[0]} {udp_rxbuf_addr[1]} {udp_rxbuf_addr[2]} {udp_rxbuf_addr[3]} {udp_rxbuf_addr[4]} {udp_rxbuf_addr[5]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 32 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {udp_rxbuf_d[0]} {udp_rxbuf_d[1]} {udp_rxbuf_d[2]} {udp_rxbuf_d[3]} {udp_rxbuf_d[4]} {udp_rxbuf_d[5]} {udp_rxbuf_d[6]} {udp_rxbuf_d[7]} {udp_rxbuf_d[8]} {udp_rxbuf_d[9]} {udp_rxbuf_d[10]} {udp_rxbuf_d[11]} {udp_rxbuf_d[12]} {udp_rxbuf_d[13]} {udp_rxbuf_d[14]} {udp_rxbuf_d[15]} {udp_rxbuf_d[16]} {udp_rxbuf_d[17]} {udp_rxbuf_d[18]} {udp_rxbuf_d[19]} {udp_rxbuf_d[20]} {udp_rxbuf_d[21]} {udp_rxbuf_d[22]} {udp_rxbuf_d[23]} {udp_rxbuf_d[24]} {udp_rxbuf_d[25]} {udp_rxbuf_d[26]} {udp_rxbuf_d[27]} {udp_rxbuf_d[28]} {udp_rxbuf_d[29]} {udp_rxbuf_d[30]} {udp_rxbuf_d[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list udp_rxbuf_ce]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list ros2/udp_rxbuf_ip_grant]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list ros2/udp_rxbuf_ip_rel]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 1 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list udp_rxbuf_we]]
