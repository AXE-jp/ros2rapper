...
#define ENTITYID_PARTICIPANT                                                   \
  { 0x00, 0x00, 0x01, 0xc1 }
#define ENTITYID_BUILTIN_PARTICIPANT_WRITER                                    \
  { 0x00, 0x01, 0x00, 0xc2 }
#define ENTITYID_BUILTIN_PARTICIPANT_READER                                    \
  { 0x00, 0x01, 0x00, 0xc7 }
#define ENTITYID_BUILTIN_PUBLICATIONS_WRITER                                   \
  { 0x00, 0x00, 0x03, 0xc2 }
#define ENTITYID_BUILTIN_PUBLICATIONS_READER                                   \
  { 0x00, 0x00, 0x03, 0xc7 }
#define ENTITYID_BUILTIN_SUBSCRIPTIONS_WRITER                                  \
  { 0x00, 0x00, 0x04, 0xc2 }
#define ENTITYID_BUILTIN_SUBSCRIPTIONS_READER                                  \
  { 0x00, 0x00, 0x04, 0xc7 }
