...
#define READ_AND_CHECKSUM                                                      \
  ...
  case UDP_IN_STATE_READ_HEADER:
    ...
    switch (offset) {
    case IN_STREAM_OFFSET_SRC_ADDR_0:
      src_addr[0] = data;
      break;
    case IN_STREAM_OFFSET_SRC_ADDR_1:
      src_addr[1] = data;
      break;
    case IN_STREAM_OFFSET_SRC_ADDR_2:
      src_addr[2] = data;
      break;
    case IN_STREAM_OFFSET_SRC_ADDR_3:
      src_addr[3] = data;
      break;
    case IN_STREAM_OFFSET_TOT_LEN_0:
      tot_len[0] = data;
      break;
    case IN_STREAM_OFFSET_TOT_LEN_1:
      tot_len[1] = data;
      break;
    case (IN_STREAM_HDR_SIZE + UDP_HDR_OFFSET_SPORT):
      src_port[0] = data;
      break;
    case (IN_STREAM_HDR_SIZE + UDP_HDR_OFFSET_SPORT + 1):
      src_port[1] = data;
      break;
  ...
  case UDP_IN_STATE_OUT_UDP:
    ...
    case 0:
      rawudp_rxbuf[ram_offset++] =
          QUAD_UINT8(src_addr[0], src_addr[1], src_addr[2], src_addr[3]);
      return;
    case 1:
      rawudp_rxbuf[ram_offset++] =
    ...
    default:
      ...
      if (data_pos == 3 || end)
        rawudp_rxbuf[ram_offset++] =
            QUAD_UINT8(data_buf[0], data_buf[1], data_buf[2], data_buf[3]);
      data_pos++;
