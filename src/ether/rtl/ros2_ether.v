...
`endif
    ...
    output wire ros2_sub_app_data_len_valid,
    output wire [`ROS2_APP_DATA_LEN_WIDTH-1:0] ros2_sub_app_data_len,
    output wire ros2_sub_app_data_rep_id_valid,
...
`endif
    ...
    .ros2_sub_app_data_len_valid(ros2_sub_app_data_len_valid),
    .ros2_sub_app_data_len(ros2_sub_app_data_len),
    .ros2_sub_app_data_rep_id_valid(ros2_sub_app_data_rep_id_valid),
