...
module raw_eth_rx_adapter (
    ...
    localparam [4:0] COUNT_ONLY              = 5'd4; // When the packet length exceeds `ROS2_MAX_RAW_ETH_MAX_DATA_LEN - 2
    localparam [4:0] SENDING_MEM_DATA_00     = 5'd5; // Send data_mem data
    localparam [4:0] SENDING_MEM_DATA_01     = 5'd6;
    localparam [4:0] SENDING_MEM_DATA_02     = 5'd7;
    localparam [4:0] SENDING_MEM_DATA_03     = 5'd8;
    localparam [4:0] SENDING_MEM_DATA_04     = 5'd9;
    localparam [4:0] SENDING_MEM_DATA_05     = 5'd10;
    localparam [4:0] SENDING_MEM_DATA_06     = 5'd11;
    localparam [4:0] SENDING_MEM_DATA_07     = 5'd12;
    localparam [4:0] SENDING_MEM_DATA_08     = 5'd13;
    localparam [4:0] SENDING_MEM_DATA_09     = 5'd14;
    localparam [4:0] SENDING_MEM_DATA_10     = 5'd15;
    localparam [4:0] SENDING_MEM_DATA_11     = 5'd16; // Finish write packet data and become IDLE next
    localparam [4:0] WAIT_LAST               = 5'd17; // Ignore the receiving packet
    ...
    wire is_direct_broadcast = ((unicast_mask & broadcast_mask) == 32'd0);
    ...
    always @* begin
        ...
        if (state_reg == IDLE) begin
            ...
            if (!is_arp || !is_ipv4_to_me || is_fragment || !is_rtps) begin
