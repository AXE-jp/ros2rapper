...
module top (
    ...
    // Internal 200 MHz clock
    wire sysclk_mmcm_out;
    wire clk_int;
    ...
    always @(posedge clk_int or negedge RSTB) begin
        if (!RSTB) begin
            sync_rst_reg <= 0;
        end else begin
            sync_rst_reg <= {sync_rst_reg[2:0], RSTB & mmcm_locked};
        end
    end
